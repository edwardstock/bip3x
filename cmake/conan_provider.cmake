...
set(CMAKE_CONAN_BUILD 1)
# Add _conan_opts to function conan_install:
# set(CONAN_ARGS ${CONAN_ARGS} -of=${CONAN_OUTPUT_FOLDER})
# list(APPEND CONAN_ARGS ${_conan_opts})
macro (conan_set_option raw_option)
	if (NOT ${raw_option} IN_LIST _conan_opts)
		list(APPEND _conan_opts "-o ${raw_option}")
	endif ()
endmacro ()
