 ...
 *
 * (translated to c from Bitcoin Cores src/crypto/sha256_sse4.cpp).
 */
...
void TransformSSE4(uint32_t *s, const uint32_t *chunk, size_t blocks) {
    ...
    static const uint32_t FLIP_MASK[] ALIGNED(16) = {0x00010203, 0x04050607, 0x08090a0b, 0x0c0d0e0f};
    static const uint32_t SHUF_00BA[] ALIGNED(16) = {0x03020100, 0x0b0a0908, 0xffffffff, 0xffffffff};
    static const uint32_t SHUF_DC00[] ALIGNED(16) = {0xffffffff, 0xffffffff, 0x03020100, 0x0b0a0908};
    uint32_t a, b, c, d, f, g, h, y0, y1, y2;
    uint64_t tbl;
    uint64_t inp_end, inp;
    uint32_t xfer[4] ALIGNED(16);
