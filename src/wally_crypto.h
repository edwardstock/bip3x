 ...
 */
BIP39_CORE_API int wally_scrypt(
 ...
 */
BIP39_CORE_API int wally_aes_cbc(
    const unsigned char *key,
    size_t key_len,
 ...
 */
BIP39_CORE_API int wally_sha256(
    const unsigned char *bytes,
    size_t bytes_len,
    unsigned char *bytes_out,
    size_t len);
 ...
 * :param len: The length of ``bytes_out`` in bytes. Must be ``SHA256_LEN``.
 */
BIP39_CORE_API int wally_sha256d(
    const unsigned char *bytes,
    size_t bytes_len,
    unsigned char *bytes_out,
    size_t len);
 ...
 */
BIP39_CORE_API int wally_sha512(
    const unsigned char *bytes,
    size_t bytes_len,
    unsigned char *bytes_out,
    size_t len);
 ...
 */
BIP39_CORE_API int wally_hash160(
    const unsigned char *bytes,
    size_t bytes_len,
    unsigned char *bytes_out,
    size_t len);
 ...
 */
BIP39_CORE_API int wally_hmac_sha256(
    const unsigned char *key,
    size_t key_len,
    const unsigned char *bytes,
    size_t bytes_len,
 ...
 */
BIP39_CORE_API int wally_hmac_sha512(
    const unsigned char *key,
    size_t key_len,
    const unsigned char *bytes,
    size_t bytes_len,
 ...
 */
BIP39_CORE_API int wally_pbkdf2_hmac_sha256(
    const unsigned char *pass,
    size_t pass_len,
    const unsigned char *salt,
    size_t salt_len,
 ...
 */
BIP39_CORE_API int wally_pbkdf2_hmac_sha512(
    const unsigned char *pass,
    size_t pass_len,
    const unsigned char *salt,
    size_t salt_len,
 ...
 */
BIP39_CORE_API int wally_ec_private_key_verify(
 ...
 */
BIP39_CORE_API int wally_ec_public_key_from_private_key(
    const unsigned char *priv_key,
    size_t priv_key_len,
    unsigned char *bytes_out,
    size_t len);
 ...
 */
BIP39_CORE_API int wally_ec_public_key_decompress(
 ...
 */
BIP39_CORE_API int wally_ec_sig_from_bytes(
    const unsigned char *priv_key,
    size_t priv_key_len,
    const unsigned char *bytes,
    size_t bytes_len,
 ...
 * :param len: The length of ``bytes_out`` in bytes. Must be ``EC_SIGNATURE_LEN``.
 */
BIP39_CORE_API int wally_ec_sig_normalize(
 ...
 * :param written: Destination for the number of bytes written to ``bytes_out``.
 */
BIP39_CORE_API int wally_ec_sig_to_der(
    const unsigned char *sig,
    size_t sig_len,
    unsigned char *bytes_out,
    size_t len,
 ...
 * :param len: The length of ``bytes_out`` in bytes. Must be ``EC_SIGNATURE_LEN``.
 */
BIP39_CORE_API int wally_ec_sig_from_der(
    const unsigned char *bytes,
    size_t bytes_len,
    unsigned char *bytes_out,
    size_t len);
 ...
 * :param sig_len: The length of ``sig`` in bytes. Must be ``EC_SIGNATURE_LEN``.
 */
BIP39_CORE_API int wally_ec_sig_verify(
    const unsigned char *pub_key,
    size_t pub_key_len,
    const unsigned char *bytes,
    size_t bytes_len,
 ...
 * :param written: Destination for the number of bytes written to ``bytes_out``.
 */
BIP39_CORE_API int wally_format_bitcoin_message(const unsigned char *bytes,
                                                size_t bytes_len,
                                                uint32_t flags,
                                                unsigned char *bytes_out,
                                                size_t len,
