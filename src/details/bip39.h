 ...
 */
BIP3X_CORE_API int bip39_get_languages(std::vector<std::string> &output);
 ...
 */
BIP3X_CORE_API int bip39_get_wordlist(
    const char *lang,
    struct words **output);
 ...
 * \return
 */
BIP3X_CORE_API int bip39_get_languages_size();
 ...
 */
BIP3X_CORE_API int bip39_get_word(
 ...
 * .. note:: The string returned should be freed using `wally_free_string`.
 */
BIP3X_CORE_API int bip39_mnemonic_from_bytes(
    const struct words *w,
 ...
 */
BIP3X_CORE_API int bip39_mnemonic_to_bytes(
    const struct words *w,
    const char *mnemonic,
 ...
 */
BIP3X_CORE_API int bip39_mnemonic_validate(
    const struct words *w,
    const char *mnemonic);
 ...
 * :param written: Destination for the number of bytes written to ``bytes_out``.
 */
BIP3X_CORE_API int bip39_mnemonic_to_seed(
    const char *mnemonic,
    const char *password,
    unsigned char *bytes_out,
    size_t len,
